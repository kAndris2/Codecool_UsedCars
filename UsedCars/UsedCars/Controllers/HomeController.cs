...
namespace UsedCars.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Search([FromQuery(Name = "brand")] string brand, [FromQuery(Name = "model")] string model, [FromQuery(Name = "type")] string type,
            ...
            [FromQuery(Name = "odometer-to")] int oto, [FromQuery(Name = "cylinder-from")] int cfrom, [FromQuery(Name = "cylinder-to")] int cto, [FromQuery(Name = "type_designation")] string tdes)
        {
